...
<td><a href="../start/experiment-accelerator-access.md"><img width="70%" alt="introduzione" src="../assets/do-not-localize/a-b-test.png"></a><br/><a href="../start/experiment-accelerator-access.md">Introduzione a Journey Optimizer Experimentation Accelerator</a></td>
<td><a href="../start/experiment-accelerator-best-practices.md"><img width="70%" alt="best practice" src="../assets/do-not-localize/best-practices.png"></a><br/><a href="../start/experiment-accelerator-best-practices.md">Best practice per Journey Optimizer Experimentation Accelerator</a></td>
<td><a href="../track/experiment-accelerator-monitor.md"><img width="70%" alt="tracciamento" src="../assets/do-not-localize/track.png"></a></br><a href="../track/experiment-accelerator-monitor.md">Tracciare e monitorare le prestazioni degli esperimenti</a></td>
</tr>
</table>
