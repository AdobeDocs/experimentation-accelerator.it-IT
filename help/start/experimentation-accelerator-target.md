---
keywords: acceleratore sperimentazione;area di lavoro target;assegnazione sandbox;adobe percorsi optimizer;integrazioni
description: Scopri come mappare le aree di lavoro di Adobe Target alle sandbox di Experimentation Accelerator in modo che i team possano visualizzare gli esperimenti di Adobe Target e Adobe Journey Optimizer in un’unica posizione.
title: Come posso integrare  [!DNL Target]  con Experimentation Accelerator?
...
Prima di impostare le assegnazioni della sandbox, verifica di disporre delle autorizzazioni necessarie. Per accedere a **[!UICONTROL Amministrazione]** in Experimentation Accelerator, è necessario disporre dell&#39;autorizzazione **[!UICONTROL Gestisci configurazione]**.

Gli utenti possono assegnare [!DNL Target] aree di lavoro alle sandbox solo quando sono soddisfatte entrambe le condizioni:

* L&#39;utente dispone dell&#39;autorizzazione **[!UICONTROL Gestisci configurazione]** in Experimentation Accelerator.
...
1. In Experimentation Accelerator aprire **[!UICONTROL Amministrazione]**.
